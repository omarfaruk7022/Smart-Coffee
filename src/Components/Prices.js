...
const Prices = () => {
  return (
    <div className="bg-[url(https://i.ibb.co/w0wrx9x/coffee-7066308-960-720.jpg)] bg-cover bg-center bg-no-repeat py-12">
      ...
      <div className="grid grid-cols-3 text-center text-white ">
        <div className="1st row">
          <div className="mt-12">
            ...
            <h1 className="text-gray-300">Espresso and Light Layer of Crema</h1>
          </div>
          <div className="mt-12">
            <div className="flex justify-center ">
              <h1 className=" text-white text-2xl">Coffe Latte </h1>
